...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  // Giảm giá cố định demo (10%)
  double get _discount => widget.totalPrice * 0.1;
  double get _originalPrice => widget.totalPrice + _discount;
  double get _finalPrice => widget.totalPrice;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Địa chỉ
          Text(
            '${widget.hotel.address}, ${widget.hotel.city}, Việt Nam',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Bảng giá
          _buildPriceRow('Giá gốc:', _originalPrice, strikethrough: false),
          const SizedBox(height: 6),
          _buildPriceRow('Giảm giá người dùng mới:', -_discount,
              strikethrough: false, isDiscount: true),
          const SizedBox(height: 12),
          const Divider(height: 1, color: AppColors.divider),
          const SizedBox(height: 12),
  ...
  Widget _buildPriceRow(String label, double amount,
      {bool strikethrough = false, bool isDiscount = false}) {
    final color = isDiscount ? Colors.green : AppColors.textSecondary;
    final prefix = isDiscount && amount < 0 ? '' : '';
    ...
    return Row(
      children: [
        ...
        Text(
          '${isDiscount ? "- " : ""}${_formatPrice(displayAmount.abs())} VND',
          style: TextStyle(
            fontSize: 13,
            color: color,
